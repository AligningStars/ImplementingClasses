...
class Point(object):        # inherit every functionality of object
    ...
    def move_to(self, x, y):
        ...
        self.traveled = self.traveled + self.get_distance_from(last)
    ...
    def closer_to(self, point2, point3):
        ...
        distance3 = math.sqrt((self.x - point3.x) ** 2 + (self.y - point3.y) ** 2)
...
def run_test_repr():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 4.  Follow the same instructions as in TODO3 above,
...
def run_test_clone():
   ...
   """
    # ------------------------------------------------------------------
    # DONE: 5.  Follow the same instructions as in TODO3 above,
...
def run_test_move_to():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 6.  Follow the same instructions as in TODO3 above,
...
def run_test_move_by():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 7.  Follow the same instructions as in TODO3 above,
...
def run_test_get_number_of_moves_made():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 8.  Follow the same instructions as in TODO3 above,
...
def run_test_get_distance_from():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 9.  Follow the same instructions as in TODO3 above,
...
def run_test_get_distance_from_start():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 10.  Follow the same instructions as in TODO3 above,
...
def run_test_get_distance_traveled():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 11.  Follow the same instructions as in TODO3 above,
...
def run_test_closer_to():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 12.  Follow the same instructions as in TODO3 above,
...
def run_test_halfway_to():
    ...
    """
    # ------------------------------------------------------------------
    # DONE: 13.  Follow the same instructions as in TODO3 above,
